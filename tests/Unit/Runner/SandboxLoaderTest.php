 ...
 *
 * Uses WPWORKER_SANDBOX_DIR (defined in bootstrap) as the real temp sandbox so
...
/**
 * @covers \WPWorker\Runner\SandboxLoader
 */
final class SandboxLoaderTest extends TestCase {

	/**
	 * Absolute path to the test sandbox directory.
	 * Equals WPWORKER_SANDBOX_DIR so the SandboxLoader constant and the test
	...
	protected function setUp(): void {
		...
		// WPWORKER_SANDBOX_DIR is defined in bootstrap — use it directly.
