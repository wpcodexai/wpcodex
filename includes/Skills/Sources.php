 ...
 *
 * Sources are registered via the wpworker_skill_sources filter. Each source
...
class Sources {
	...
	public static function registry(): array {
		...
		$sources = apply_filters( 'wpworker_skill_sources', $default );
	...
	/**
	 * Loader for the user DB source — reads from wpworker_skills table.
	 *
