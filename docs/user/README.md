# AllyWorker User Guide

AllyWorker gives AI agents full control over a WordPress site through the MCP protocol.

## Guides

1. [Get Started](./00-get-started.md) — Install the plugin, enable abilities, generate a password, connect your AI client
2. [Abilities Reference](./01-abilities.md) — Every `allyworker/*` tool, its inputs, and usage notes
...
| Execute PHP on the server | [Abilities → php-execute](./01-abilities.md#allyworkerphp-execute) |
