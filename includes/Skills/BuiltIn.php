 ...
 *
 * Registered with the wpworker_skill_sources filter at priority 10 so built-ins
...
class BuiltIn {
	...
	/**
	 * Wire the wpworker_skill_sources filter.
	 *
	 * @since 1.0.0
	 */
	public function __construct() {
		add_filter( 'wpworker_skill_sources', [ $this, 'add_source' ] );
	}
